...
public class ServiceController {
    ...
    @GetMapping("/getByFoodTruck/{name}")
    public ResponseEntity getByFoodTruck(@PathVariable String name){
        return ResponseEntity.status(HttpStatus.OK).body(serviceService.getByFoodTruck(name));
    }
}
